...
st.write("Project: image classification AI system based on Resnet50 and pytorch")
st.markdown("---")
        ...
        with st.spinner("Analyzing"):
            try:
                ...
                if response.status_code == 200:
                    ...
                    st.caption(
                    f"Disclaimer: This result is generated by an AI model and may be inaccurate. This tool should not be the sole basis for assessing an image's authenticity. ")
                else:
